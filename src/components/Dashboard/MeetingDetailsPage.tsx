...
export default function MeetingDetailsPage() {
  const datatofeed = {
    id: "1",
    name: "Businees Meeting with Mo Ashraf - July 16, 2024",
    description:
      "The meeting focused on municipal governance, including the approval of the agenda and minutes, discussions on healthcare support through Stars, financial decisions regarding the purchase of trailers, and a review of financial statements. The council also acknowledged the importance of community events and the need for infrastructure improvements.",
    transcript:
    ...
    summary:
      "The meeting commenced with introductions and a land acknowledgment. The agenda and previous minutes were approved unanimously. The council discussed the consent agenda, highlighting support for Stars air ambulance services and the increase in bursary amounts for graduates. New business included the approval of purchases for an asphalt hotbox trailer and a rehabilitation trailer, both funded from the vehicle and equipment reserve. Financial statements were reviewed, with a request for clarification on tax levy delays.",
    breakdown: {
      Tasks: [
        {
      ...
      Decisions: [
        {
          decision:
            "Approved the purchase of one new asphalt hotbox trailer from Industrial Machine Inc not to exceed $155,000.",
          date: "2024-07-16T00:00:00.000Z",
          details: "Funds to come from the vehicle and equipment reserve.",
        },
        {
          decision:
            "Approved the purchase of one new rehabilitation trailer from ProPAC for $59,630.27 U.S.",
          date: "2024-07-16T00:00:00.000Z",
          details: "Funds to come from the vehicle and equipment reserve.",
        },
        {
          decision:
            "Increased the bursary amount for SCI grad recipients from $500 to $750.",
          date: "2024-07-16T00:00:00.000Z",
          details: "Funds to come from the vehicle and equipment reserve.",
        },
      ],
      Questions: [
        {
          question:
            "Are we purchasing the asphalt hotbox trailer ourselves or using a procurement company?",
          status: "answered",
          answer:
      ...
      Insights: [
        {
          insight:
            "Stars air ambulance services are critical for healthcare in the RM of Springfield.",
          reference: "Discussion on item 10.2 regarding Stars.",
        },
        {
          insight:
      ...
      Attendees: [
        ...
        {
          name: "Glen Fuel",
          role: "Counselor Ward 1",
        },
        {
          name: "Andy Kaczynski",
          role: "Counselor Ward 2",
        },
        {
          name: "Mark Miller",
          role: "Counselor Ward 3",
        },
        {
          name: "Melinda Warren",
          role: "Counselor Ward 4",
        },
      ],
      "Follow-ups": [
        {
      ...
      Agenda: [
        {
          item: "Introduction and land acknowledgment",
        },
        {
          item: "Approval of the agenda",
        },
        {
          item: "Adoption of previous meeting minutes",
        },
        {
          item: "Question period",
        },
        {
          item: "Consent agenda items",
        },
        {
          item: "Discussion on Stars air ambulance services",
        },
        {
          item: "Thank you card for SCI grad recipients",
        },
        {
          item: "New business: Purchase of asphalt hotbox trailer",
        },
        {
          item: "New business: Purchase of rehabilitation trailer",
        },
        {
          item: "Review of financial statements",
        },
      ],
    },
  };
    ...
    return (
      <div className="container mx-auto p-6">
        <button
          ...
          className="mb-4 flex items-center text-purple-500 hover:text-purple-700"
        >
  ...
  console.log("Rendering MeetingDetails with data:", datatofeed);
  return (
    <div>
      <button
        onClick={handleGoBack}
      ...
      <MeetingDetails data={datatofeed} />
    </div>
  );
}
